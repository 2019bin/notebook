...
3. 语料的及时弥补
   ...
   - 注意:不用追求每次的记忆效果，但是一定要复习，尤其是记不住的，多过几遍

4. 跟读模仿（第五周）
   - 所需材料:《摩登家庭》视频任意一季
   - 使用方法:只看前5集，1周花5天时间，每天1集，每次1个半小时
      - 找一张纸把中文字幕贴起来，借助英文字幕看剧，先从头到尾看一遍
...
6. 跟读模仿（第六周）
   ...
   - 例如：It's about being spontaneous. 你就可以想一下谁对你说什么话的时候你可能会说这句，然后假装这事儿发生了，你回复他。（一定要出声，并且带着场景感。）
...
8. 实战训练
   - 所需材料：一个以英语母语国家的老外。（渠道有太多了：在中国的留学生，语言交换网站等等）
      - 不要担心犯错，这是最最最最最关键的一步
